...
import harbour.metro.routes.linemodel 1.0
import ".."
...
Dialog {
    ...
    property string lang: linemodel.get_lang()
...
//                }
////                console.log(last_append_line_name,stationmodel.fulllistdata(i,StationModel.LineRole))
//            }
//        }
        function update() {
            ...
            for(var i=0; i<linemodel.rowCount(); i++){
                append({"line_name": linemodel.data(i,LineModel.LineNameRole),
                           "line_colour": linemodel.data(i,LineModel.LineColourRole)})
//                console.log(linemodel.data(i,LineModel.LineNameZhRole))
            }
        }
    }
...
//                                          qsTr("未选择出发站") :
                                          qsTr("Start station not selected") :
