...
DISTFILES += qml/harbour-metro-routes.qml \
    ...
    metro_routes_data/guangzhou_foshan_20260213.sqlite \
    metro_routes_data/shenzhen_20251228.sqlite \
...
db.files += $$PWD/metro_routes_data/guangzhou_foshan_20260213.sqlite
dbsz.path = /usr/share/harbour-metro-routes
dbsz.files += $$PWD/metro_routes_data/shenzhen_20251228.sqlite
INSTALLS += db \
    dbsz
