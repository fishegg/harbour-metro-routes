...
Station::Station()
{
    ...
    unpaid_interchange[3] = -1;
    unpaid_interchange[4] = -1;
    _action = -1;
    _towards = "";
...
Station::Station(int n, int c, int i1, int i2, int i3, int i4, int i5, int ui1, int ui2, int ui3, int ui4, int ui5, QString snum, QString sname, int lid, QString lname, QString lcolour, bool i)
{
    num = n;
    count = c;
    stn_name = sname;
    ...
    unpaid_interchange[3] = ui4;
    unpaid_interchange[4] = ui5;
    _action = -1;
    _towards = "";
